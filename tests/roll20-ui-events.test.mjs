...
test("UI actions share approval cards, receipts and durable retry protection", () => {
  for (const [type, input] of [["tool-switch_layer", { layer: "gm" }], ["tool-drop_image", { imageId: "image-1" }], ["tool-compendium_import", { pageName: "Goblin", category: "Monsters", expansionId: 2 }], ["tool-close_character_window", { characterId: "goblin" }]]) {
