...
const GENERAL_CAPABILITY_INSTRUCTIONS = [
  ...
  "User-attached images are stored locally and announced with an imageId. Use inspect_image with that exact ID when visual inspection would help; do not claim to have seen an attachment before inspecting it.",
